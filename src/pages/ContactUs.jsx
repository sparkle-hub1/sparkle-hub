    ...
    <div className="max-w-4xl mx-auto w-full pt-8 pb-16 px-4 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
        ...
        <InfoCard
          ...
          label="Facebook"
          value="Sparkle Hub"
          sub="Connect with us on Facebook"
        />
        <InfoCard
          icon="✉️"
          label="Email"
      ...
      <div className="bg-white/90 border border-rose-100 rounded-[2rem] p-8 md:p-10 shadow-sm mb-8">
        ...
        <p className="text-rose-800/70 text-sm font-medium leading-relaxed mb-8">
          The fastest way to get help is via WhatsApp, Instagram or Facebook. For formal queries you can also email us directly. We reply to every message personally.
        </p>
        <div className="flex flex-col xl:flex-row gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 flex-1 py-5 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl font-black text-lg shadow-[0_10px_25px_rgba(59,130,246,0.3)] hover:shadow-[0_15px_35px_rgba(59,130,246,0.4)] transition-all transform hover:-translate-y-1 outline-none"
          >
            <svg className="w-6 h-6 shrink-0" viewBox="0 0 24 24" fill="currentColor">
